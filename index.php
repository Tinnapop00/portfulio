...
$perpage = 9;
 ...
 $start = ($page - 1) * $perpage;
    ...
    $query = "SELECT * FROM goods LIMIT {$start} , {$perpage}" or die("Error:" . mysqli_error($conn)); 
            ...
            <div class="card h-100">
              ...
              <div class="card-body">
                <h5 class="card-title">
                  ...
                  <h6>กิโลกรัม ละ <?php echo $show["p_price"]; ?>&nbsp;บาท</h6>
                  ...
                  <div class="d-flex justify-content-end">
                    ...
                    <a href="check.php?p_id=<?=$show['p_id'];?>&act=add" class="btn-sm btn-success "
                      style="text-decoration:none;"><i class="fa fa-cart-plus" aria-hidden="true"></i>&nbsp;เพิ่มในตะกร้าสินค้า</a>
