...
$perpage = 9;
 ...
 $start = ($page - 1) * $perpage;
                ...
                $sql =" SELECT * FROM goods INNER JOIN type_product on goods.p_id= type_product.t_ip WHERE p_pro_status='on' LIMIT {$start} , {$perpage}"  ;
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                ...
                <h1 class="my-4">ผักสวนครัวป้าเอียด</h1>
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">
                                    ...
                                    <?php
                                        $pro = $show["p_price"]*$show["p_pro_value"]/100;
                                    ?>
                                    <h6>฿<?php echo $show["p_price"]- $pro; ?>&nbsp;บาท&nbsp;<span style='color:red'>(<?=$show["p_pro_value"]?>%)</span></h6>
                                    <h7>จากปกติ&nbsp;<del>฿<?=$show["p_price"]?></del> บาท</h7> <br>
